...
async function updateTopChannels() {
  ...
  channels.forEach((c, i) => {
    ...
    row.innerHTML = `
      ...
      <div class="avatar" style="background:${avatarColor(c.channel)}">${c.channel[0].toUpperCase()}<img src="/avatars/twitch/${encodeURIComponent(c.channel)}" alt="" onerror="this.remove()"></div>
